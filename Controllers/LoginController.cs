...
namespace CompanyManagement.Controllers
{
    public class LoginController : Controller
    {
        ...
        public IActionResult Login()
        {
            ...
            {
                return (vmUser.RoleType == 1) ? RedirectToAction("Index", "Dashboard") : RedirectToAction("Index", "EmployeeDashboard");
            }
        ...
        public IActionResult Login(User user)
        {
            try
            {
                ...
                if (registeredUser != null)
                {
                    ...
                    return (registeredUser.RoleType == 1) ? RedirectToAction("Index", "AdminDashboard") : RedirectToAction("Index", "Dashboard");
                }
        ...
        private VmUser? LoggedInUser(string userName, string password)
        {
            try
            {
                ...
                {
                    var sql = $@"select u.*,ur.RoleName,ur.RoleType from [User] u inner join UserRole ur on ur.Id = u.UserRoleId where u.Username = '{userName}' and UserPassword = '{password}' and ActiveStatus= {(int)PropertyConstant.Active}";
